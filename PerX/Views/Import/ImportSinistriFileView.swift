...
struct ImportSinistriFileView: View {
...
extension ImportSinistriFileView.ImportStep: CaseIterable {
    static var allCases: [ImportSinistriFileView.ImportStep] {
